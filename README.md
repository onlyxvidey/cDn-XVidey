...
var monthFormat = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    noThumbnail = "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg0y9KyseYRXrbUx1XoQM3NC4tcsOywk7qnn5P6r0IM_j0MnW7TMC_RqMOrk2O1eci8SisUjXwpG0jMXewFyCYPbMmAs6XzKfKbdtD9RqGDdvdmwT8kr2Lp9Ze6_egFRPGCwC0eI9sjO5o/w680/nth.png",
    postPerPage = 7,
    fixedSidebar = true,
        ...
        <div class='post-content'>
          <a class='post-image-link' expr:href='data:post.url'>
            <b:if cond='data:post.featuredImage'>
              ...
              <b:else/>
              <img class='post-thumb' expr:alt='data:post.title' src='https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg0y9KyseYRXrbUx1XoQM3NC4tcsOywk7qnn5P6r0IM_j0MnW7TMC_RqMOrk2O1eci8SisUjXwpG0jMXewFyCYPbMmAs6XzKfKbdtD9RqGDdvdmwT8kr2Lp9Ze6_egFRPGCwC0eI9sjO5o/w680/nth.png'/>
            </b:if>
          </a>
          <div class='post-info'>
            <h2 class='post-title'>
...
<script src='//forgavedisciplinetolerance.com/8b/51/4c/8b514c3834bfee337a813cbbf46f5743.js' type='text/javascript'/>
</head>
...
<!-- Main Top Bar -->
        ...
        <b:section class='top-bar-social social' id='top-bar-social' maxwidgets='1' name='Social Top' showaddelement='yes'>
           <b:widget id='LinkList73' locked='true' title='' type='LinkList' version='2' visible='false'>
             <b:widget-settings>
               ...
               <b:widget-setting name='text-4'>skype</b:widget-setting>
             </b:widget-settings>
             <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
  ...
  <div id='header-wrap'>
    ...
    <div class='header-header'>    
      <div class='container row'>
          <b:section class='header-logo' id='header-logo' maxwidgets='1' name='Header Logo' showaddelement='yes'>
            <b:widget id='Header1' locked='true' title='Roberta VIP (Header)' type='Header' version='2' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjhrt2kT4_mYsHJyCL6OHKGWAiBZ9gtMBH8h8HF1pNwNcq_FbjGJR9ur-6rJh6T-LK7uD3aQWb8j00LmMbDQ8Y0cMi53ws3bshF_w5Oe2NuxeN1ythzFRqFGRyZ1c3gHCRsNsh89D-cF7-I/s104/logo.png</b:widget-setting>
	...
	atOptions = {
		'key' : 'f14dcad3ad77030b410ba71d550d98bf',
		'format' : 'iframe',
		'height' : 50,
		'width' : 320,
		'params' : {}
...
<script type="text/javascript" src="//forgavedisciplinetolerance.com/f14dcad3ad77030b410ba71d550d98bf/invoke.js"></script>]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    ...
    <div class='mobile-header'>
      ...
      <b:section class='mobile-logo' id='mobile-logo' maxwidgets='1' name='Mobile Logo' showaddelement='yes'>
        <b:widget id='Image70' locked='true' title='Mobile Logo' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjKXw1zou2WTDDV1jV2H0h0PA5cHxmj1dBXYEQ2rLbKLk4VAqbLW6OE0Lor_MCMzK3mg27FgcE-s7utVQrEEcgVj7jAgA438NX1ASHRlcg6aAG-e5XKMAKHe8RVi_H5vtyqlvGQeIR4BMW2/s1600/logo_mobile.png</b:widget-setting>
 ...
 &quot;publisher&quot;: {
  ...
  <b:include data='{ iconClass: (&quot;touch-icon sharing-&quot; + data:platform.key) }' expr:name='data:platform.key + &quot;Icon&quot;'/>
      ...
      <div id='sidebar-wrapper'>
        <b:section class='sidebar common-widget' id='sidebar1' name='Sidebar Right (A)' showaddelement='yes'>
          <b:widget id='HTML3' locked='false' title='Key' type='HTML' visible='false'>
            <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='BlogSearch1' locked='false' title='Cari Blog Ini' type='BlogSearch' visible='false'>
            <b:includable id='main' var='this'>
      <b:include name='widget-title'/>
      <b:include name='content'/>
    </b:includable>
  ...
  <b:include name='reportAbuse'/>
          ...
          <b:widget cond='!data:view.isPost' id='PageList1' locked='false' title='' type='PageList' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='pageListJson'><![CDATA[{"link0":{"href":"http://ladiesoncam.blogspot.com/","position":0,"title":"Beranda"}}]]></b:widget-setting>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
          ...
          <b:widget id='Profile1' locked='false' title='Mengenai Saya' type='Profile' visible='false'>
            <b:widget-settings>
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://www.blogger.com/navbar/2702083248986668126?origin\x3dhttp://localhost:80&#39;,
...
&lt;/script&gt;
  ...
  <b:include name='content'/>
        ...
        <b:section class='sidebar common-widget' id='sidebar2' name='Sidebar Right (B)' showaddelement='yes'>
          <b:widget cond='data:view.isSingleItem and data:posts any (p =&gt; p.id != data:view.postId)' id='PopularPosts1' locked='false' title='Popular Posts' type='PopularPosts' version='2' visible='false'>
            <b:widget-settings>
      ...
      <article class='post' role='article'>
        <b:include name='snippetedPostContent'/>
          ...
          <b:widget id='HTML6' locked='false' title='Facebook' type='HTML' visible='false'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<center><div class="fb-page" data-https://www.facebook.com/share/15fqja2cxl/?mibextid=wwxifr" data-width="360" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"></div></center>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='HTML5' locked='false' title='Subscribe Us' type='HTML' visible='false'>
            <b:widget-settings>
...
height: 100%;
  ...
  <div class='widget-content'>
    <data:content/>
          ...
          <b:widget id='Label3' locked='false' title='Categories' type='Label' visible='false'>
            <b:widget-settings>
  ...
  <div class='container row'>
    <div class='footer-widgets-wrap'>
      <b:section class='footer common-widget' id='footer-sec1' maxwidgets='3' name='Section (Left)' showaddelement='yes'>
        <b:widget cond='data:view.isHomepage' id='FeaturedPost1' locked='false' title='Featured Post' type='FeaturedPost' version='2' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='showSnippet'>false</b:widget-setting>
            <b:widget-setting name='showPostTitle'>true</b:widget-setting>
            <b:widget-setting name='postId'>5227137954408236362</b:widget-setting>
    ...
    <b:loop values='data:posts filter (p =&gt; p.id != data:view.postId)' var='post'>
      ...
      <b:section class='footer common-widget' id='footer-sec2' maxwidgets='3' name='Section (Center)' showaddelement='yes'>
        <b:widget id='HTML2' locked='false' title='Ads' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!-- Histats.com  START  (aync)-->
<script type="text/javascript">var _Hasync= _Hasync|| [];
_Hasync.push(['Histats.start', '1,4749575,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img src="//sstatic1.histats.com/0.gif?4749575&amp;101" alt="" border="0" /></a></noscript>
<!-- Histats.com  END  -->]]></b:widget-setting>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='Label1' locked='false' title='Categories' type='Label' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
            <b:widget-setting name='display'>LIST</b:widget-setting>
            <b:widget-setting name='selectedLabelsList'/>
  ...
  <b:loop values='data:labels' var='label'>
    <span class='label-size'>
      ...
      <ul>
        ...
        <b:widget id='Label2' locked='false' title='Tags' type='Label' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='sorting'>ALPHA</b:widget-setting>
            <b:widget-setting name='display'>LIST</b:widget-setting>
            <b:widget-setting name='selectedLabelsList'/>
  ...
  <b:loop values='data:labels' var='label'>
    <span class='label-size'>
      ...
      <b:section class='footer common-widget' id='footer-sec3' maxwidgets='3' name='Section (Right)' showaddelement='yes'>
        <b:widget id='PopularPosts2' locked='false' title='Most Popular' type='PopularPosts' version='2' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='numItemsToShow'>3</b:widget-setting>
...
<div id='sub-footer-wrapper'>
 ...
 <div class='widget-content'>
   <ul>
    ...
    <div class='copyright-area'>Created By <a href='https://t.co/R65Ts1bfCA' id='mycontent' rel='dofollow' title='SoraTemplates'>Blog</a> | Distributed By <a href='https://t.co/R65Ts1bfCA' rel='dofollow' style='color:#ff00ba;' target='_blank' title='Gooyaabi'>Gooyaabi</a>
    </div>
  </div>
</div>
</div>
